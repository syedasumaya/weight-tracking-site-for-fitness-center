        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <?php } ?>
                    <form  role="form" action="<?php echo base_url('admin/another_update/' . $weight->description_id); ?>" method="post">
                        <?php //print_r($weight);?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    <div class="weight_range">
                                        ...
                                        <input style="width:55px" type="text" name="low_wgt_range" value="<?php echo $weight->low_wgt_range; ?>" class="form-control" placeholder=""/>
                                        <span>-</span>
                                        <input style="width:55px" type="text" name="end_range_1" value="<?php echo $weight->end_range_1; ?>" class="form-control" placeholder=""/>
                                        &nbsp;<span>lbs</span>
                                        <span style="border-right: 1px dotted grey; margin-right: 10px; margin-left: 10px;"></span>
                                        <input style="width:55px" type="text" name="start_range_2" value="<?php echo $weight->start_range_2; ?>" class="form-control" placeholder=""/>
                                        <span>-</span>
                                        <input style="width:55px" type="text" name="high_wgt_range" value="<?php echo $weight->high_wgt_range; ?>" class="form-control" placeholder=""/>
                                        &nbsp;<span>lbs</span>
                                    </div> 
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    ...
                                    <input style="width:119px" type="text" name="wgt_inc" value="<?php echo $weight->wgt_inc; ?>" class="form-control" placeholder=""/>
                                    &nbsp;<span>lbs</span>
                                    <span style="border-right: 1px dotted grey; margin-right: 10px; margin-left: 10px;"></span>
                                    <input style="width:119px" type="text" name="wgt_inc_2" value="<?php echo $weight->wgt_inc_2; ?>" class="form-control" placeholder=""/>
                                    &nbsp;<span>lbs</span>
                                </div> 
                            </div>
